            ...
            <div class="md:flex no-wrap md:-mx-2 ">
                ...
                <div class="w-full md:w-3/12 md:mx-2">
                    ...
                    <div class="bg-white p-3 border-t-4 border-green-400">
                        ...
                        <h1 class="text-gray-900 font-bold text-xl leading-8 my-1">{{ $comic['title'] }}</h1>
{{--                        <h3 class="text-gray-600 font-lg text-semibold leading-6">{{ $comic['attributionText'] }}</h3>--}}
                        <p class="text-sm text-gray-500 hover:text-gray-600 leading-6">{{ $comic['description'] }}</p>
                        <ul
                            class="bg-gray-100 text-gray-600 hover:text-gray-700 hover:shadow py-2 px-3 mt-3 divide-y rounded shadow-sm">
                            <li class="flex items-center py-3">
                                <span>Resource Url</span>
                                <a href="{{ $comic['resourceURI'] }}" class="ml-auto"><span
                                        class="bg-green-500 py-1 px-2 rounded text-white text-sm">Visit</span></a>
                            </li>
                            <li class="flex items-center py-3">
                                <span>Last Modified</span>
                                <span class="ml-auto">{{ $comic['modified'] }}</span>
                            </li>
                        </ul>
                    </div>
                    <!-- End of profile card -->
